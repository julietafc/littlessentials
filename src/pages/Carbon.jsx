    ...
    <>
      ...
      <div className="lowcarbon">
        ...
        <section className="section1">
          <p>
            If you would like more info about how you can reduce your digital footprint, feel free to reach out to us via
            <a title="link to contact Littlessentials by email" href="mailto: info@littlessentials.dk">
              info@littlessentials.dk
            </a>
            and we’ll be happy to share what we know with you. Every small change starts with a seed of awareness.
          </p>
        </section>
      </div>
      <Footer />
