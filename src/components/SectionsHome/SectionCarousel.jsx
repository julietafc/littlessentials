        ...
        <Carousel>
          ...
          <Carousel.Item>
            ...
            <div className="text">
              <h4>Konges Sløjd</h4>
              <p>
                Konges Sløjd is a creative brand that salutes the wild, varied and perfectly imperfect life with children. The brand aims to blaze a trail for garments, toys and interiors produced in a way that is kinder to the environment and made
                to last. Everything is crafted to survive snuggly newborns, adventurous toddlers or curious children and still be passed on.
              </p>
            </div>
          </Carousel.Item>
          <Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <div className="text">
              ...
              <p>
                Cam Cam Copenhagen’s core originates from the love of babies and children, and a belief that they only deserve the best. They create quality, timeless and tactile design for children, offering poetic products which help create calm
                and harmonious environments. Their overall design focus is sustainability - this means sustainable, organic production and enduring design and material quality.
              </p>
            </div>
          </Carousel.Item>
          <Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <div className="text">
              <h4>Wauw Kapow</h4>
              <p>
                Wauw Kapow creates children’s clothes inspired by the playful spirit of children.They believe children are free to wear whatever they want, and a lot of our clothes are therefore not gender-specific. To resist the hard job of being
                worn by playing children all day, our clothes are made of high-quality textiles. Their designs are inspired by modern and conceptional arts and colors, the comfortable and functional elements of streetwear.
              </p>
            </div>
          </Carousel.Item>
          <Carousel.Item>
